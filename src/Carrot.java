...
// Written by: Mr. Swope
// Date: 1/27/2020
// Description: This class implements a Carrot.  This Carrot will be drawn onto a graphics panel. 
// 
...
public class Carrot{
	...
	public Carrot(int x_coordinate, int y_coordinate, String imageString){
	...
	public Carrot(int x_coordinate, int y_coordinate, String imageString, int imageScale){
	...
	public Rectangle getBounds(){
		return new Rectangle(x_coordinate+25, y_coordinate, image.getIconWidth(), 
				image.getIconHeight());
	}
