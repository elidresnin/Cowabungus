...
public class Heart{
	...
	public Heart(){
		this(68, 0, "images/forest/objects/Tree_2.png", 2);
	}
	...
	public Heart(int x_coordinate, int y_coordinate, String imageString){
	...
	public Heart(int x_coordinate, int y_coordinate, String imageString, int imageScale){
