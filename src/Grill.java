...
public class Grill{
	...
	public Grill(){
		this(500, 300, "images/forest/objects/Grill for Project-02 (1)", 2);
	}
	...
	public Grill(int x_coordinate, int y_coordinate, String imageString){
	...
	public Grill(int x_coordinate, int y_coordinate, String imageString, int imageScale){
	...
	public Rectangle getBounds(){
		return new Rectangle(x_coordinate+50, y_coordinate, image.getIconWidth()-100, 
				image.getIconHeight());
	}
	...
	// description: This method will return true if the Item collides with the parameter Item.
	// return: boolean - true if the two items intersect or collide with each other, otherwise false. 
	public boolean collision(Grill otherItem) {
	...
	//return type: void
	//description: This method sets the coordinates of a specific grill. 
