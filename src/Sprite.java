...
public class Sprite {
	...
	public Sprite(int x_coordinate, int y_coordinate){
		...
		imageResource = new ImageResource("images/cow/", 2, 80);
		jumpCounter = -1;

	}

	//method: collision
	//parameters: Sprite otherSprite
	//return type: boolean
	//description: This method returns either true or false as to whether or not this sprite is intersecting another sprite.
	...
	//method: collision
	//parameters: Grill item
	//return type: boolean
	//description: This method returns either true or false as to whether or not this sprite is intersecting a grill.
	public boolean collision(Grill item) {
		return getBounds().intersects(item.getBounds());
	}

	//method: collision
	//parameters: Carrot item
	//return type: boolean
	//description: This method returns either true or false as to whether or not this sprite is intersecting a carrot.
	public boolean collision(Carrot item) {
		return getBounds().intersects(item.getBounds());
	}


	//method: collision
	//parameters: Haybale item
	//return type: boolean
	//description: This method returns either true or false as to whether or not this sprite is intersecting a haybale.
	public boolean collision(Haybale item) {
		return getBounds().intersects(item.getBounds());
	}
	...
	public Rectangle getBounds(){
		if(x_direction < 0)
			...
			return new Rectangle(x_coordinate + 2 * imageResource.getImageOffset() + 400, y_coordinate + 75, 
					imageResource.getImage().getIconWidth() - 250 - ((imageResource.getImageOffset()/2)), 
					imageResource.getImage().getIconHeight()-175);		
	}
	...
	//return type: void
	//description: This method sets the coordinates of a specific sprite.
